...
This repository contains code for the SPHINXMerkleBlock project, which is a merkle module for the SPHINX blockchain framework. The SPHINXMerkleBlock aims to provide a "Merkle trees" in the blockchain systems
